...
namespace Runtime.RestClient.Implementations.DMT.ElmsServices.ManagePlotPartialBlockClients
{
    internal class ManagePlotPartialBlockMockClient : IManagePlotPartialBlockClient
    {
        ...
        private static async Task<string> GetFileContent(string fileName)
        {
            ...
            var filePath = Path.Combine(basePath, "Response", "ElmsServices", "ManagePlotPartialBlock", fileName);
        ...
        public async Task<ErrorOr<DmtResponseWrapper<ManagePlotPartialBlockResponse>>> GetStepInfo(List<Cookie> cookies, string args)
        {
            ...
            return JsonSerializer.Deserialize<DmtResponseWrapper<ManagePlotPartialBlockResponse>>(content);
        }
