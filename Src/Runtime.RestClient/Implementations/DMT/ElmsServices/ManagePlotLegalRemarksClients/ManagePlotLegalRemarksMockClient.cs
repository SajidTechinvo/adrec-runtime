...
{
    internal class ManagePlotLegalRemarksMockClient : IManagePlotLegalRemarksClient
    {
        ...
        private static async Task<string> GetFileContent(string fileName)
        {
            ...
            var filePath = Path.Combine(basePath, "Response", "ElmsServices", "ManagePlotLegalRemarks", fileName);
        ...
        public async Task<ErrorOr<DmtResponseWrapper<ManagePlotLegalRemarksResponse>>> GetStepInfo(List<Cookie> cookies, string args)
        {
            ...
            return JsonSerializer.Deserialize<DmtResponseWrapper<ManagePlotLegalRemarksResponse>>(content);
        }
