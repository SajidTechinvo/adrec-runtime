...
{
    public class LandUsageResponse
    {
        ...
        public object JoinedLandUseA { get; set; }

        [JsonPropertyName("joinedLandUseE")]
        public object JoinedLandUseE { get; set; }

        [JsonPropertyName("urlArgs")]
        public object UrlArgs { get; set; }
    }

    public class LandUsageByIdResponse
    {
        [JsonPropertyName("buildingPercent")]
        public double BuildingPercent { get; set; }
        ...
        [JsonPropertyName("parentLanduseId")]
        public object ParentLanduseId { get; set; }
