...
namespace Runtime.DTO.RestClientModels.DMT.ElmsServices.ManagePlotLegalRemarks
{
    public class ManagePlotLegalRemarksResponse
    {
        ...
        public string StepOrganizationUnitNameA { get; set; }

        [JsonPropertyName("stepOrganizationUnitNameE")]
        public string StepOrganizationUnitNameE { get; set; }
        ...
        public string ResultTextE { get; set; }
