...
namespace Runtime.DTO.RestClientModels.DMT.ElmsServices.ManagePlotComment
{
    public class ManagePlotCommentResponse
    {
        ...
        [JsonPropertyName("selectedPlotComment")]
        public object SelectedPlotComment { get; set; }
