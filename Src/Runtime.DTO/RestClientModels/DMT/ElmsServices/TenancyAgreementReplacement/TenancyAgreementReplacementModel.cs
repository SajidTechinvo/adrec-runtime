...
namespace Runtime.DTO.RestClientModels.DMT.ElmsServices.TenancyAgreementReplacement
{
    public class TenancyAgreementReplacementResponse
    {
        ...
        public List<PlotOwnerResponse> OwnersList { get; set; }
        ...
        public object Lessor { get; set; }

        [JsonPropertyName("isOnline")]
        public bool IsOnline { get; set; }

        [JsonPropertyName("isFineCheckVisible")]
        public bool IsFineCheckVisible { get; set; }

        [JsonPropertyName("contractPaymentsPendingAmount")]
        public double ContractPaymentsPendingAmount { get; set; }

        [JsonPropertyName("latePaymentsPendingAmount")]
        public double LatePaymentsPendingAmount { get; set; }
        ...
        public object RentItems { get; set; }

        [JsonPropertyName("activePlotTrasactionApproveDate")]
        public object ActivePlotTrasactionApproveDate { get; set; }

        [JsonPropertyName("activePlotTrasactionTypeA")]
        public object ActivePlotTrasactionTypeA { get; set; }

        [JsonPropertyName("activePlotTrasactionTypeE")]
        public object ActivePlotTrasactionTypeE { get; set; }

        [JsonPropertyName("plotOwnershipHistory")]
        public object PlotOwnershipHistory { get; set; }
