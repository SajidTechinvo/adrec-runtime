...
namespace Runtime.DTO.RestClientModels.DMT.ElmsServices.ClearanceCertificate
{
    public class ClearanceCertificateResponse
    {
        ...
        public object ApplicationPayments { get; set; }
