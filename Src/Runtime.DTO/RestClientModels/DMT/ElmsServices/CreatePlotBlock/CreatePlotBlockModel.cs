...
namespace Runtime.DTO.RestClientModels.DMT.ElmsServices.CreatePlotBlock
{
    public class CreatePlotBlockResponse
    {
        ...
        public string AuthoritySourceTypeName { get; set; }
