...
namespace Runtime.DTO.RestClientModels.DMT.ElmsServices.AllowLandTrading
{
    public class AllowLandTradingResponse
    {
        [JsonPropertyName("evaluationAmount")]
        public double? EvaluationAmount { get; set; }

        [JsonPropertyName("owners")]
        public List<OwnerListResponse> Owners { get; set; }
        ...
        public List<object> ApplicationPayment { get; set; }
