...
namespace Runtime.DTO.RestClientModels.DMT.ElmsServices.UnassignedAllotmentTemporaryPlot
{
    public class UnassignedAllotmentTemporaryPlotResponse
    {
        [JsonPropertyName("allotmentOrder")]
        public AllotmentOrderResponse AllotmentOrder { get; set; }

        [JsonPropertyName("ownersList")]
        public object OwnersList { get; set; }

        [JsonPropertyName("selectedPlot")]
        public object SelectedPlot { get; set; }

        [JsonPropertyName("tenancyContract")]
        public object TenancyContract { get; set; }
