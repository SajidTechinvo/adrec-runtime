...
namespace Runtime.DTO.RestClientModels.DMT.ElmsServices.ManageUnitLegalRemarks
{
    public class ManageUnitLegalRemarksResponse
    {
        [JsonPropertyName("allotmentOrder")]
        public object AllotmentOrder { get; set; }

        [JsonPropertyName("selectedUnit")]
        public UnitDetailResponse SelectedUnit { get; set; }
