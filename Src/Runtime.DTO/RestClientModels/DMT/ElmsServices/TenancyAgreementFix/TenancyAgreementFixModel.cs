...
{
    public class TenancyAgreementFixResponse
    {
        ...
        public List<PlotOwnerResponse> Tenants { get; set; }
        ...
        [JsonPropertyName("isFarm")]
        public bool IsFarm { get; set; }

        [JsonPropertyName("isRanch")]
        public bool IsRanch { get; set; }

        [JsonPropertyName("tenancyContractPayments")]
        public List<object> TenancyContractPayments { get; set; }

        [JsonPropertyName("newTenancyLawDate")]
        public DateTime NewTenancyLawDate { get; set; }

        [JsonPropertyName("annualRentFeesPerUnitLabelAfterDate")]
        public object AnnualRentFeesPerUnitLabelAfterDate { get; set; }
