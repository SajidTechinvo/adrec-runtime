...
namespace Runtime.DTO.RestClientModels.DMT.ElmsServices.CreateUnitBlock
{
    public class CreateUnitBlockResponse
    {
        ...
        public object AuthoritySourceId { get; set; }
        ...
        [JsonPropertyName("isOtherAuthoritySourceName")]
        public bool IsOtherAuthoritySourceName { get; set; }

        [JsonPropertyName("authoritySourceTypeName")]
        public object AuthoritySourceTypeName { get; set; }

        [JsonPropertyName("blockInitiator")]
        public string BlockInitiator { get; set; }

        [JsonPropertyName("plot")]
        public object Plot { get; set; }

        [JsonPropertyName("plotOwners")]
        public object PlotOwners { get; set; }

        [JsonPropertyName("unitProfile")]
        public UnitProfileResponse UnitProfile { get; set; }
